...
<form method="post">
  ...
  <input type="text" class="form-control"value="<?php echo $usuario ["usuario"];  ?> " placeholder="Escriba su nombre" id="nombre" name="actualizarNombre">
</div>
...
$actualizar = ControladorFormularios::ctrActualizarRegistro();
  ...
  echo'<div class = "alert alert-danger"> Error al actualzar el usuario </div>';
